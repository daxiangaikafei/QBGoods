...
class MyLabelsTheme extends Component {
  constructor(props) {
    super(props)
  ...
  tabCallback  = (active) => {
    ...
    this.getData(1, {
      page:1,
      themeId: this.state.goodsTabs[active].id
    });
  }
  getTabs(){
    let _this = this;
  ...
  getData(num,searchParam){
      ...
      let _this = this;
      let param = Object.assign({},{page: page, themeId: activeId, size: pageSize}, searchParam);
      page = param.page;
...
MyLabelsTheme.defaultProps = {
  tabUrl: "/stuff/theme/getUserTheme.do",
  listUrl: "/stuff/theme/getStuffList.do",
  pageSize: 8
}
export default CSSModules(MyLabelsTheme,styles,{allowMultiple:true});
